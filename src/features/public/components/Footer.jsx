...
const Footer = () => {
  return (
    <footer className="bg-white antialiased dark:bg-gray-800 mt-auto border-t-2">
  <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">

    <div className="py-6 md:py-8">
      <div className="gap-4 space-y-5 xl:flex xl:items-center xl:justify-between xl:space-y-0">
        <a href="#"  className="block">
          <img className="block h-8 w-auto dark:hidden" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/logo-full.svg" />
          <img className="hidden h-8 w-auto dark:block" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/logo-full-dark.svg" />
        </a>
